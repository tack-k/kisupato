    ...
    <li @click="linkChatroomShow(chatroom.chatroom_id)" class="py-3 sm:py-4 px-1 sm:px-12 hover:bg-gray-50 hover:cursor-pointer">
        <div class="flex items-center space-x-3">
            <div class="w-2/12 flex items-center flex-col">
                <div :class="setConsultationColor(chatroom.consultation_status)" class="text-xs px-1 py-0.5 rounded mb-0.5">{{ chatroom.consultation_status_name }}</div>
            ...
            <p v-if="chatroom.message !== null" class="w-4/12 limit-string px-4 py-2 rounded-lg inline-block rounded-tl-none bg-blue-600 text-white text-sm">
                {{ chatroom.message }}
            </p>
            <div class="w-2/12">
