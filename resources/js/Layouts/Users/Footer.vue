        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com" target="_blank" class="flex items-center">
                    ...
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Kispato</span>
                </a>
            </div>
                    ...
                    <ul>
                        <li class="mb-4">
                            <a href="https://github.com/themesberg/flowbite" target="_blank"
                               class="text-gray-600 hover:underline dark:text-gray-400">よくある質問</a>
                        </li>
                        <li>
                            <Link :href="route('contact.create')" target="_blank"
                               class="text-gray-600 hover:underline dark:text-gray-400">お問い合わせ</Link>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul>
                        <li class="mb-4">
                            <a href="#" target="_blank" class="text-gray-600 hover:underline dark:text-gray-400">プライバシーポリシー</a>
                        </li>
                        <li>
