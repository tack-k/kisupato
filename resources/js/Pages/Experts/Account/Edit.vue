    ...
    <my-page-layout>
        <template #content>
            <form @submit.prevent="submit">
                ...
                <div class="mt-4 text-blue-400 base-font-bold expert-hover">
                ...
                <div class="flex justify-center mt-4">
                    ...
                    <Link :href="route('expert.account.show')" class="expert-outline-btn">戻る</Link>
                </div>
            </form>
        </template>
    </my-page-layout>
...
export default {
    ...
    setup() {
        ...
        const form = useForm({
            last_name_kana: expert.value.last_name_kana,
            first_name_kana: expert.value.first_name_kana,
            last_name: expert.value.last_name,
            first_name: expert.value.first_name,
            tel: expert.value.tel,
            postal_code: expert.value.postal_code,
            region: expert.value.city,
            city: expert.value.region,
            street: expert.value.street,
            building: expert.value.building,
            gender: expert.value.gender,
            birthday: expert.value.birthday,
            email: expert.value.email,
            current_password: '',
            password: '',
        ...
        const submit = () => {
            form.post(route('expert.account.update'), {
