<template>
    ...
    <form @submit.prevent="submit">
        <div>
            <breeze-label for="email" value="メールアドレス" />
        ...
        <div class="flex items-center justify-end mt-4">
            <inertia-link v-if="canResetPassword" :href="route('expert.password.request')" class="underline text-sm text-gray-600 hover:text-gray-900">
                パスワードを忘れた方はこちら
            </inertia-link>
...
<script>
    ...
    export default {
        ...
        methods: {
            submit() {
                this.form.post(this.route('expert.login'), {
