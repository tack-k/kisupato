                    ...
                    <table class="base-table">
                        ...
                        <tr class="base-th-tr">
                            <th class="base-th-th" v-if="canDelete">
                                <form @submit.prevent="submitDelete(deleteUrl, I_SELECT_TAG, I_DELETE_TAG)">
                        ...
                        <tr v-for="(searchedTableContent, index) in searchedTableContents" :key="index"
                            ...
                            <td class="base-tb-td">
                                <div class="flex justify-center">
                                    <Link :href="route('admin.tag.edit', {'id': searchedTableContent.id})" as="button" methods="get">
...
export default {
    ...
    setup(props) {
        ...
        const NO_RESULTS = -1
        const { data, links } = toRefs(props.tags)
        const { I_DELETE_TAG, I_SELECT_TAG } = messageConst
        ...
        //送信先
        const keywordUrl = route('admin.tag.index')
        const deleteUrl = route('admin.tag.delete')
