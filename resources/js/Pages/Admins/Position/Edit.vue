        ...
        <template #content>
            <div class="container mx-auto pt-4 py-16 admin-bg-white">
                <div class="w-3/4 py-10 flex flex-col items-center mx-auto">
                    ...
                    <h2 class="base-font-m mb-10">専門人材肩書編集</h2>
                    <form @submit.prevent="submit()">
                        <div class="mt-4 mb-20">
                            <div class="mr-2">
                                <label-required for="name" value="専門人材肩書名"/>
                        ...
                        <div class="flex items-center justify-center p-6 border-t border-solid border-blueGray-200 rounded-b">
                            <div class="mr-6">
                                <Link :href="route('admin.position.index')" class="admin-outline-btn">戻る</Link>
                            </div>
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => {
            form.put(route('admin.position.update', {'id': position.id}), {
                onSuccess: () => {
                    form.reset()
                }
            })
